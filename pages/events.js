...
export default function Events() {
  return (
    ...
    <div className="overflow-hidden bg-white py-24 sm:py-32">
      ...
      <h3 className="text-6xl font-semibold  text-indigo-600 ">Interested in performing at the Falling Rock Cafe?</h3>
      <p>Click below to fill out a form, and we will reach out with further information</p>
      <button>Potential performers</button>
      </div>
      </div>
      </div>
    </div>
